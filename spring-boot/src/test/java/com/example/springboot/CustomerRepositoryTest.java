...
class CustomerRepositoryTest {
    ...
    @Test
    void findAllByName() {
        List<Customer> actual = sut.getCustomerByNameIgnoreCase("name 1");
    ...
    void findAllByNameNoMatch() {
        List<Customer> actual = sut.getCustomerByNameIgnoreCase("name 3");
        assertThat(actual).isEmpty();
    }

    @Test
    void findAllByLastName() {
        List<Customer> actual = sut.getCustomerByLastNameIgnoreCase("last name 1");
        for (Customer customer : actual) {
    ...
    void findAllByLastNameNoMatch() {
        List<Customer> actual = sut.getCustomerByLastNameIgnoreCase("last name 3");
        assertThat(actual).isEmpty();
    }

    @Test
    void findAllByNameAndLastName() {
        List<Customer> actual = sut.getCustomerByNameIgnoreCaseAndLastNameIgnoreCase("name 1", "last name 1");
        for (Customer customer : actual) {
            assertThat(customer.getName()).isEqualTo("name 1");
            assertThat(customer.getLastName()).isEqualTo("last name 1");
        }
    ...
    void findAllByNameAndLastNameNoMatch() {
        List<Customer> actual = sut.getCustomerByNameIgnoreCaseAndLastNameIgnoreCase("name 3", "last name 3");
        assertThat(actual).isEmpty();
    }
